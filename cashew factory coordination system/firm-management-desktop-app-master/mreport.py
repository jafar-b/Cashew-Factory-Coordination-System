...
def main():
    ...
    sql  = "select sum(quantity) from raw_material where type='Kokan' and raw='A' and adate like '%s'"%(find)
    print(sql)
    cur.execute(sql)
    ka = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='Benin' and raw='A' and adate like '%s'"%(find)
    cur.execute(sql)
    ba = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='Ghana' and raw='A' and adate like '%s'"%(find)
    cur.execute(sql)
    ga = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='African' and raw='A' and adate like '%s'"%(find)
    cur.execute(sql)
    aa = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='Kokan' and raw='Kokan' and adate like '%s'"%(find)
    cur.execute(sql)
    fpreform2 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='Benin' and raw='Benin' and adate like '%s'"%(find)
    cur.execute(sql)
    flable2 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='B' and raw='Ghana' and adate like '%s'"%(find)
    cur.execute(sql)
    fcaps2 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='B' and raw='African' and adate like '%s'"%(find)
    cur.execute(sql)
    fboxes2 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='C' and raw='Kokan' and adate like '%s'"%(find)
    cur.execute(sql)
    fpreform3 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='C' and raw='Benin' and adate like '%s'"%(find)
    cur.execute(sql)
    flable3 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='C' and raw='Ghana' and adate like '%s'"%(find)
    cur.execute(sql)
    fcaps3 = cur.fetchone()
    sql  = "select sum(quantity) from raw_material where type='C' and raw='African' and adate like '%s'"%(find)
    cur.execute(sql)
